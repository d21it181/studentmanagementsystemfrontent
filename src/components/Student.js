...
export default function Student(props) {
  ...
  useEffect(() => {
    if (studentId) {
      axios
        .get("https://8080-learnwithpa-studentmana-mirwur2mjns.ws-us62.gitpod.io//student/" + studentId)
        .then((response) => {
  ...
  let saveStudent = (event) => {
    event.preventDefault();
      ...
      axios
        .post("https://8080-learnwithpa-studentmana-mirwur2mjns.ws-us63.gitpod.io/student", student)
        .then((response) => {
          if (response.data != null) {
  ...
  let updateStudent = (event) => {
    event.preventDefault();
    axios.put("https://8080-learnwithpa-studentmana-mirwur2mjns.ws-us63.gitpod.io/student/" + studentId, student).then((response) => {
      if (response.data != null) {
